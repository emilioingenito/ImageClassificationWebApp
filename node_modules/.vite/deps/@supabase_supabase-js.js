...
var resolveFetch = (customFetch) => {
  ...
  if (customFetch) {
    ...
    _fetch = (...args) => __awaiter(void 0, void 0, void 0, function* () {
      return yield (yield import("./browser-ponyfill-VCQQNWTK.js")).fetch(...args);
    });
  } else {
    _fetch = fetch;
  }
...
var RealtimeClient = class {
  ...
  throttle(callback, eventsPerSecondLimit = this.eventsPerSecondLimitMs) {
    return () => {
      if (this.inThrottle)
        return true;
      callback();
...
var resolveResponse = () => __awaiter6(void 0, void 0, void 0, function* () {
  if (typeof Response === "undefined") {
    return (yield import("./browser-ponyfill-VCQQNWTK.js")).Response;
  }
  return Response;
});
